...
namespace System.Net.Http.Formatting.Parsers
{
    ...
    internal class MimeMultipartParser
    {
        ...
        public MimeMultipartParser(string boundary, long maxMessageSize)
        {
            ...
            Guard.Against.NullOrWhiteSpace(boundary, nameof(boundary));
        ...
        private class CurrentBodyPartStore
        {
            ...
            /// The body part.
            /// </value>
            public ArraySegment<byte> BodyPart { get; set; } = MimeMultipartParser.EmptyBodyPart;
