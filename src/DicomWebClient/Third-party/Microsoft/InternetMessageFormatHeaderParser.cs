...
namespace System.Net.Http.Formatting.Parsers
{
    ...
    internal class InternetMessageFormatHeaderParser
    {
        ...
        public InternetMessageFormatHeaderParser(HttpHeaders headers, int maxHeaderSize, bool ignoreHeaderValidation)
        {
            ...
            {
                throw new ArgumentException("maxHeaderSize");
            }
        ...
        {
            Guard.Against.Null(buffer, nameof(buffer));
        ...
        private class CurrentHeaderFieldStore
        {
            ...
            /// </summary>
            public StringBuilder Name { get; } = new StringBuilder(CurrentHeaderFieldStore.DefaultFieldNameAllocation);

            /// <summary>
            /// Gets the header field value.
            /// </summary>
            public StringBuilder Value { get; } = new StringBuilder(CurrentHeaderFieldStore.DefaultFieldValueAllocation);
            ...
            public void CopyTo(HttpHeaders headers, bool ignoreHeaderValidation)
            {
                ...
                var value = Value.ToString().Trim(CurrentHeaderFieldStore.LinearWhiteSpace);
