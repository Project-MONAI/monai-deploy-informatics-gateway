...
namespace Monai.Deploy.InformaticsGateway.Test.PlugIns
{
    ...
    public class TestOutputDataPlugInAddMessage : IOutputDataPlugIn
    {
        ...
        public Task<(DicomFile dicomFile, ExportRequestDataMessage exportRequestDataMessage)> ExecuteAsync(DicomFile dicomFile, ExportRequestDataMessage exportRequestDataMessage)
        {
