...
namespace Monai.Deploy.InformaticsGateway.Test.Services.Connectors
{
    public class PayloadNotificationServiceTest
    {
        ...
        private readonly Mock<IServiceScopeFactory> _serviceScopeRetryFactory;
        ...
        public PayloadNotificationServiceTest()
        {
            ...
            _serviceScopeRetryFactory = new Mock<IServiceScopeFactory>();
            ...
            _serviceScopeRetryFactory.Setup(p => p.CreateScope()).Returns(scope.Object);
        ...
        public void PayloadNotificationService_Constructor()
        {
            ...
            Assert.Throws<ArgumentNullException>(() => new PayloadNotificationService(_fileSystem.Object, _payloadAssembler.Object, _storageService.Object, _logger.Object, _options, _serviceScopeRetryFactory.Object, null, null));
            Assert.Throws<ArgumentNullException>(() => new PayloadNotificationService(_fileSystem.Object, _payloadAssembler.Object, _storageService.Object, _logger.Object, _options, _serviceScopeRetryFactory.Object, _messageBrokerPublisherService.Object, null));
        }
        ...
        public void PayloadNotificationService_ShallStopProcessing()
        {
            ...
            var service = new PayloadNotificationService(_fileSystem.Object,
                                                         ...
                                                         _logger.Object,
                                                         _options,
                                                         _serviceScopeRetryFactory.Object,
