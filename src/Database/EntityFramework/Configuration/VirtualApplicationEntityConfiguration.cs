...
#pragma warning disable CS8604, CS8603
    ...
    internal class VirtualApplicationEntityConfiguration : IEntityTypeConfiguration<VirtualApplicationEntity>
    {
        public void Configure(EntityTypeBuilder<VirtualApplicationEntity> builder)
        {
            ...
            builder.Property(j => j.VirtualAeTitle).IsRequired();
            ...
            builder.HasIndex(p => p.Name, "idx_virtualae_name").IsUnique();
