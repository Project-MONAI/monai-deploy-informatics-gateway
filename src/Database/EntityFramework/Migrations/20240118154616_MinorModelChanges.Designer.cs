            ...
            modelBuilder.Entity("Monai.Deploy.InformaticsGateway.Api.Models.HL7DestinationEntity", b =>
                {
                    ...
                    b.HasIndex(new[] { "Name", "HostIp", "Port" }, "idx_source_all")
                        .IsUnique()
            ...
            modelBuilder.Entity("Monai.Deploy.InformaticsGateway.Api.Rest.InferenceRequest", b =>
                {
                    ...
                    b.Property<string>("InputMetadata")
                        .HasColumnType("TEXT")
                        .HasAnnotation("Relational:JsonPropertyName", "inputMetadata");

                    b.Property<string>("InputResources")
                        .HasColumnType("TEXT")
                        .HasAnnotation("Relational:JsonPropertyName", "inputResources");

                    b.Property<string>("OutputResources")
                        .HasColumnType("TEXT")
                        .HasAnnotation("Relational:JsonPropertyName", "outputResources");
                    ...
                    b.Property<int>("TryCount")
                        .HasColumnType("INTEGER")
                        .HasAnnotation("Relational:JsonPropertyName", "tryCount");
            ...
            modelBuilder.Entity("Monai.Deploy.InformaticsGateway.Database.Api.StorageMetadataWrapper", b =>
                {
                    ...
                    b.Property<bool>("IsUploaded")
                        .HasColumnType("INTEGER")
                        .HasAnnotation("Relational:JsonPropertyName", "isUploaded");
