...
namespace Monai.Deploy.InformaticsGateway.Database.EntityFramework.Test
{
    ...
    public class MonaiApplicationEntityRepositoryTest //: IClassFixture<SqliteDatabaseFixture>
    {
        ...
        public async Task GivenAMonaiApplicationEntity_WhenAddingToDatabase_ExpectItToBeSaved()
        {
            ...
            var actual = await _databaseFixture.DatabaseContext.Set<MonaiApplicationEntity>().FirstOrDefaultAsync(p => p.Name.Equals(aet.Name)).ConfigureAwait(false);
        ...
        public async Task GivenAMonaiApplicationEntity_WhenRemoveIsCalled_ExpectItToDeleted()
        {
            ...
            var dbResult = await _databaseFixture.DatabaseContext.Set<MonaiApplicationEntity>().FirstOrDefaultAsync(p => p.Name == "AET5").ConfigureAwait(false);
