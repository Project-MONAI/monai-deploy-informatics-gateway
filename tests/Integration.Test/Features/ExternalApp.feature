...
Feature: External App Execution

This feature tests the External App Execution for saving and
re-identifying data sent and received by the MIG respectively.

    @messaging_workflow_request @messaging
    Scenario: End-to-end test of external App scp incomming
        Given a externalApp study that is exported to the test host
        When the externalApp study is received and sent back to Informatics Gateway with 1 message
